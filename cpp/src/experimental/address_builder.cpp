...
{
  switch (_impl->source) {
    case AddressBuilderSource::Worker: return ucxx::createAddressFromWorker(_impl->worker);
    case AddressBuilderSource::String: return ucxx::createAddressFromString(_impl->addressString);
  }
