...
UCXXAddress::UCXXAddress(ucp_address_t* address,
                         size_t length,
...
ucp_address_t* UCXXAddress::getHandle() const { return (ucp_address_t*)_handle; }

size_t UCXXAddress::getLength() const { return _length; }

std::string UCXXAddress::getString() const { return std::string{(char*)_handle, _length}; }
