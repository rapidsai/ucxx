...
/**
 * @brief Create a TagProbeInfoBuilder for an unmatched result.
 *
 * @return A TagProbeInfoBuilder object.
 */
[[nodiscard]] inline TagProbeInfoBuilder createTagProbeInfo() { return TagProbeInfoBuilder(); }

/**
 * @brief Create a TagProbeInfoBuilder for a matched result.
 *
 * @return A TagProbeInfoBuilder object.
 */
[[nodiscard]] inline TagProbeInfoBuilder createTagProbeInfo(const ucp_tag_recv_info_t& info,
                                                            ucp_tag_message_h handle)
{
  return TagProbeInfoBuilder(info, handle);
}
