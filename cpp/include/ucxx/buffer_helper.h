...
class Header {
 public:
  ...
  Header(std::string serializedHeader) { deserialize(serializedHeader); }
...
class UCXXPyRMMBuffer : public UCXXPyBuffer {
 public:
  ...
  void* data() { return ((rmm::device_buffer*)_ptr.get())->data(); }
