...
run_cpp_benchmark() {
  ...
  CMD_LINE_SERVER="timeout 1m ${BINARY_PATH}/benchmarks/libucxx/ucxx_perftest -s 8388608 -n 20 -P ${PROGRESS_MODE} -p ${SERVER_PORT}"
  CMD_LINE_CLIENT="timeout 1m ${BINARY_PATH}/benchmarks/libucxx/ucxx_perftest -s 8388608 -n 20 -P ${PROGRESS_MODE} -p ${SERVER_PORT} 127.0.0.1"
